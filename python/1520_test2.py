...
def findWay(current, target):
    ...
    if current == target:
        ...
        # print(checkMap)
        return
    if current[1] + 1 <= map_row-1 :
        if current[0] > Map[current[1]+1][current[2]] and checkMap[current[1] + 1][current[2]] != 0 :
            ...
            checkMap[current[1] + 1][current[2]] = -1
    if current[1] - 1 >= 0 :
        if current[0] > Map[current[1]-1][current[2]] and checkMap[current[1] - 1][current[2]] != 0:
            ...
            newCurrent1[1] = current[1] - 1
            newCurrent1[2] = current[2]
            # print('after2', newCurrent1)
            findWay(newCurrent1, target)
        else:
            checkMap[current[1] - 1][current[2]] = -1
    if current[2] + 1 <= map_col-1 :
        if current[0] > Map[current[1]][current[2] + 1] and checkMap[current[1]][current[2] + 1] != 0:
            ...
            # print('after3', newCurrent1)
            # print(checkMap)
            findWay(newCurrent1, target)
        else:
            checkMap[current[1]][current[2] + 1] = -1
    if current[2] - 1 > 0 :
        if current[0] > Map[current[1]][current[2] - 1] and checkMap[current[1]][current[2] - 1] != 0:
